...
RUN --mount=type=secret,id=GUIX_CACHE_SIGNING_KEY_SEC cp /run/secrets/GUIX_CACHE_SIGNING_KEY_SEC /etc/guix/signing-key.sec && chmod 0400 /etc/guix/signing-key.sec && ls -alh /etc/guix/
